      ...
      >
        ...
        {user ? (
          <Box sx={{ mt: 2, textAlign: "center" }}>
            ...
            {/* Display Permissions */}
            <Box sx={{ mt: 3 }}>
              <Typography variant="h6">Granted Permissions:</Typography>
              <List>
            ...
            {pages.length > 0 ? (
              <Box sx={{ mt: 3 }}>
                <Typography variant="h6">Your Facebook Pages:</Typography>
                <List>
                  {pages.map((page) => (
              ...
              <Typography variant="body2" sx={{ mt: 2 }}>
                No Pages found. Ensure you manage Pages and have granted pages_show_list.
              </Typography>
            )}
          </Box>
        ) : (
